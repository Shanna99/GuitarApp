...
**Core Problem:** Guitarists struggle to know if they are playing the right notes or chords while practicing.

**Core Action:** Guitarist connects their guitar (wired in MVP) to the application and receives real-time feedback on the notes, strings, and chords they play.
...
2. Guitar connection 
    ...
    - Notify user on connection or disconnection
3. Audio input detection
4. Recognition of:
