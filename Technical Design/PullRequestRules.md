...
These are guidelines for submitting a pull request.

Pull requests are how you propose changes to a repo.
PR rules are about process, not file layout:
- How to name branches.
- How to write commit messages.
- What description and tests to include.
- How reviewers approve and merge changes.
